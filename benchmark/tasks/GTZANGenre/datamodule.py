...
class AnnealingTrain(AnnealingBase):
    NAME = "train"
    
    def _load(self):
        txt_filelist = self.config["filelist"]
        with open(txt_filelist, "r") as f:
            self.data = f.read().splitlines()


class AnnealingDev(AnnealingBase):
    NAME = "dev"
...
class AnnealingTest(AnnealingBase):
    NAME = "test"
